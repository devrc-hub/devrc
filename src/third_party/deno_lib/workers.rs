...
use crate::{
    colors, fmt_errors::PrettyJsError, module_loader::CliModuleLoader, ops,
    program_state::ProgramState, source_maps::apply_source_map, version,
};
...
fn create_web_worker_callback(program_state: Arc<ProgramState>) -> Arc<CreateWebWorkerCb> {
    Arc::new(move |args| {
